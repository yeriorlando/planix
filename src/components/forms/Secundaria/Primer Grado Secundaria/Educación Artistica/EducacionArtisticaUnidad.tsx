...
const COMPETENCIAS: { key: CompetenciaKey; label: string; defaultDesc: string }[] = [
  {
    ...
    label: "Comunicativa",
    defaultDesc:
      "Realiza procesos creativos utilizando técnicas y estilos artísticos, en relación con la intención comunicativa, expresando la síntesis de ideas, sentimientos y vivencias, tanto propias como presentes en obras diversas.",
  },
  {
    key: "pensamiento_logico",
    label: "Pensamiento Lógico, Creativo y Crítico",
    defaultDesc:
      "Crea obras artísticas a partir de los aspectos constitutivos de cada disciplina artística, identificando sus elementos formales.",
  },
  {
    key: "resolucion_problemas",
    label: "Resolución de Problemas",
    defaultDesc:
      "Argumenta sobre la función de distintos lenguajes artísticos en la construcción histórica de la sociedad en los contextos diversos.",
  },
  {
    key: "etica_ciudadana",
    label: "Ética y Ciudadana",
    defaultDesc:
      "Comunica ideas, emociones, sentimientos y vivencias, a través de géneros, técnicas y estilos de diversas manifestaciones artísticas, valorando la capacidad comunicativa de estas de acuerdo con el contexto.",
  },
  {
    key: "cientifica_tecnologica",
    label: "Científica y Tecnológica",
    defaultDesc:
      "Identifica recursos tecnológicos de diferentes lenguajes artísticos en la realización o análisis de producciones artísticas.",
  },
  {
    key: "ambiental_salud",
    label: "Ambiental y de la Salud",
    defaultDesc:
      "Reconoce las posibilidades técnicas que ofrecen las artes para la valoración y uso consciente de los recursos y espacios naturales.",
  },
  {
    key: "desarrollo_personal_espiritual",
    label: "Desarrollo Personal y Espiritual",
    defaultDesc:
      "Reconoce críticamente manifestaciones artísticas multidisciplinares, identificando sus componentes e influencias, y reconociendo su trascendencia.",
  },
];
...
const FALLBACK_INDICATORS = [
  "**Comprende la función** comunicativa de gestos, palabras, acciones, formas, colores, sonidos y movimientos en las artes.",
  "**Utiliza intencionalmente los** lenguajes de las artes para comunicar ideas, vivencias, sentimientos y emociones.",
  "**Identifica elementos de** los distintos lenguajes de las artes, utilizando la terminología apropiada.",
  "**Crea obras utilizando** conscientemente los lenguajes de las artes.",
  "**Aplica criterios semióticos** y estéticos al valorar las obras artísticas que aprecia o crea.",
  "**Identifica similitudes y** diferencias en expresiones artísticas de distintos géneros y estilos.",
  "**Experimenta la síntesis** en la creación artística de formas, ideas, gestos, sonidos, movimientos y color, al realizar obras utilizando técnicas, géneros y estilos.",
  "**Interpreta y participa** en obras artísticas, aportando ideas, vivencias y emociones, al utilizar diferentes técnicas y estilos.",
  "**Identifica elementos básicos** de los lenguajes artísticos en obras propias o de otras personas.",
  "**Reconoce el valor** de los lenguajes artísticos como medio de expresión y comunicación",
  "**Valora las creaciones** artísticas propias y las de otras personas en distintos contextos y según unos criterios dados, tanto técnicos como individuales.",
  "**Argumenta sobre influencias** culturales en expresiones artísticas nacionales.",
  "**Utiliza adecuadamente recursos** tecnológicos en sus creaciones.",
  "**Asiste a manifestaciones** artísticas diversas, dentro y fuera de la escuela, realizando visitas físicas o virtuales.",
  "**Usa creativamente materiales,** espacios y objetos en sus composiciones artísticas.",
  "**Utiliza adecuadamente materiales** del medio y de fácil acceso en sus creaciones artísticas y artesanales.",
  "**Muestra adecuado uso** de sus habilidades corporales, al crear artísticamente.",
  "**Crea obras originales,** con mensajes orientados al cuidado de la salud personal y ambiental.",
  "**Asume un rol** responsable y respeta los acuerdos cuando participa en creaciones grupales.",
  "**Elabora un diario** artístico con sus reflexiones a lo largo del año escolar, manifestando autoconocimiento y creatividad al comunicarse artísticamente.",
  "**Crea, utilizando artísticamente** características y habilidades corporales, vocales, manuales, psicológicas y emocionales."
];
...
const DRAFT_KEY = "plx:sec_artistica1ro_unidad_draft";
...
<p>${result.ampliacion?.descripcion || "Actividad avanzada de investigación o creación autónoma."}</p>`;
  ...
  const handleGenerateRetroalimentacion = async () => {
    ...
    try {
        ...
        try {
          ...
          const artisticaPlans = plannings
            .filter(p => {
              ...
              const isArtistica = normAsig.includes("artistica") || normAsig.includes("arte") || normTit.includes("artistica");
              ...
              return isArtistica && isSecundariaPlan && isGrade1 && !isCurrentPlan;
            })
      ...
      const planContext = latestPlan || {
        ...
        grado: "1er Grado de Secundaria",
        level: "SECUNDARIA",
        titulo: `${selectedSequence?.name || 'Unidad'} - ${tituloPlan || 'Lenguajes Artísticos'}`,
        intencion_pedagogica: intencionPedagogica || "Reconocer y explorar las diferentes técnicas y lenguajes artísticos de la unidad.",
      };
  ...
  const handleSynthesize = async (selectedPlans: any[]) => {
    ...
    try {
      ...
      const staticUnits = getUnitsBySubjectAndGrade('educacion-artistica', '1ro Sec');
      const filteredCustom = customUnitsRaw
        .filter(cu => (cu.subject_id === 'educacion-artistica' || cu.subject_id === 'educacion-artistica-sec') && (cu.grade_id === '1ro Sec' || cu.grade_id === 'secundaria-1ro'))
        .map(cu => cu.content);
