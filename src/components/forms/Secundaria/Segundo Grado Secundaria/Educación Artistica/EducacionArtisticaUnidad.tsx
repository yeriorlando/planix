...
const COMPETENCIAS: { key: CompetenciaKey; label: string; defaultDesc: string }[] = [
  {
    ...
    label: "Comunicativa",
    defaultDesc:
      "Argumenta sobre la función de los distintos lenguajes artísticos en la construcción histórica de la sociedad en los contextos.",
  },
  {
  ...
  },
  {
    ...
    defaultDesc:
      "Utiliza elementos técnicos de distintas expresiones artísticas en sus proyectos personales y colectivos comprendiendo mensaje, forma y contenido.",
  },
  {
    key: "etica_ciudadana",
    label: "Ética y Ciudadana",
    defaultDesc:
      "Interpreta y crea piezas utilizando lenguajes artísticos a partir de aspectos sociales del contexto y que reflejan su identidad cultural.",
  },
  {
    key: "cientifica_tecnologica",
    label: "Científica y Tecnológica",
    defaultDesc:
      "Realiza procesos creativos integrando herramientas tecnológicas como apoyo en producciones artísticas.",
  },
  {
    key: "ambiental_salud",
    label: "Ambiental y de la Salud",
    defaultDesc:
      "Analiza el modo de utilización óptima de materiales, recursos y espacios propios de las artes y sus lenguajes en el cuidado de su cuerpo y conducta para la mejora de su salud y la de los distintos ambientes naturales y ecosistemas.",
  },
  {
    key: "desarrollo_personal_espiritual",
    label: "Desarrollo Personal y Espiritual",
    defaultDesc:
      "Utiliza elementos de los lenguajes artísticos como medio de expresión de su identidad personal, social y cultural.",
  },
];
...
const FALLBACK_INDICATORS = [
  "**Expresa temáticas populares** en sus creaciones artísticas, utilizando materiales diversos.",
  "**Argumenta sobre la** elección de los elementos artísticos utilizados en obras propias y de otras personas.",
  ...
  "**Compara y contrasta** distintas propuestas artísticas, reconociendo sus elementos constitutivos.",
  "**Crea obras artísticas**, utilizando referentes técnicos y estilísticos de distintas épocas.",
  "**Identifica características del** arte popular dominicano de diferentes épocas.",
  "**Utiliza adecuadamente técnicas** artísticas al crear obras diversas.",
  "**Realiza propuestas artísticas**, utilizando criterios estéticos en la adecuación y mejora de su entorno.",
  "**Usa creativamente el** espacio en sus proyectos artísticos.",
  "**Valora las creaciones** artísticas propias y las de otras personas en distintos contextos, a partir de criterios dados, tanto técnicos como individuales.",
  "**Argumenta sobre el** significado, valor y función del patrimonio artístico y cultural en la vida de los pueblos.",
  "**Identifica obras diversas** de las artes clásicas y populares, que reflejan aspectos de la realidad social.",
  "**Describe características de** diferentes géneros y estilos utilizados por artistas nacionales.",
  "**Expone creativamente los** resultados de sus investigaciones, utilizando adecuadamente herramientas tecnológicas.",
  "**Crea obras artísticas** y utiliza adecuadamente recursos tecnológicos.",
  "**Crea piezas artísticas** y artesanales con los recursos naturales desechados por la naturaleza.",
  "**Cuida su salud** e integridad personal y la de sus pares al utilizar materiales en la creación artística y artesanal.",
  "**Utiliza el reciclaje** al proponer soluciones ingeniosas que dan respuesta a problemáticas ambientales y de salud colectiva, de acuerdo al contexto.",
  "**Participa en la** creación de obras diversas inspiradas en imágenes, sonoridades, costumbres y relatos de su contexto.",
  "**Reconoce el valor** estético y funcional de materiales, objetos y accesorios de uso común en la creación artística.",
  "**Se expresa, de** manera individual o colectiva, mostrando apertura a las valoraciones de otras personas."
];
...
const DRAFT_KEY = "plx:sec_artistica2do_unidad_draft";
...
<p>${result.ampliacion?.descripcion || "Actividad avanzada de investigación o creación autónoma."}</p>`;
  ...
  const handleGenerateRetroalimentacion = async () => {
    ...
    try {
        ...
        try {
          ...
          const artisticaPlans = plannings
            .filter(p => {
              ...
              return isArtistica && isSecundariaPlan && isGrade2 && !isCurrentPlan;
            })
      ...
      const planContext = {
        ...
        grado: "2do Grado de Secundaria",
        level: "SECUNDARIA",
        titulo: latestPlan?.titulo || `${selectedSequence?.name || 'Unidad'} - ${tituloPlan || 'Lenguajes Artísticos'}`,
        intencion_pedagogica: latestPlan?.intencion_pedagogica || intencionPedagogica || "Reconocer y explorar las diferentes técnicas y lenguajes artísticos de la unidad.",
      };
  ...
  const handleSynthesize = async (selectedPlans: any[]) => {
    ...
    try {
      ...
      const staticUnits = getUnitsBySubjectAndGrade('educacion-artistica', '2do Sec');
      const filteredCustom = customUnitsRaw
        .filter(cu => (cu.subject_id === 'educacion-artistica' || cu.subject_id === 'educacion-artistica-sec') && (cu.grade_id === '2do Sec' || cu.grade_id === 'secundaria-2do'))
        .map(cu => cu.content);
