...
const COMPETENCIAS: { key: CompetenciaKey; label: string; defaultDesc: string }[] = [
  ...
  },
  {
    ...
    defaultDesc:
      "Argumenta sobre la práctica de valores vinculados al trabajo, a fin de identificar su aporte al desarrollo de las personas, la familia y la sociedad.",
  },
  {
    key: "ambiental_salud",
    label: "Ambiental y de la Salud",
    defaultDesc:
      "Propone acciones que fomentan el cuidado y sostenibilidad del entorno natural como casa común en su familia, escuela y comunidad para asumirlas y promoverlas.",
  },
  {
    key: "resolucion_problemas",
    label: "Resolución de Problemas",
    defaultDesc:
      "Analiza su realidad familiar y social, tomando en cuenta valores humanos y cristianos, a fin de plantear y promover estrategias de solución a los conflictos.",
  },
  {
    key: "desarrollo_personal_espiritual",
    label: "Desarrollo Personal y Espiritual",
    defaultDesc:
      "Reconoce los cambios que experimenta en la etapa de la adolescencia e identifica su influencia en sus intereses y comportamientos, con el propósito de tomar decisiones que favorezcan su desarrollo humano y espiritual.",
  },
  {
    key: "etica_ciudadana",
    label: "Ética y Ciudadana",
    defaultDesc:
      "Constata en la misión de Jesús de Nazaret la manifestación del amor de Dios hacia las personas, con el fin de desarrollar actitudes y acciones que favorezcan el bienestar de los demás.",
  },
];
...
const FALLBACK_INDICATORS = [
  "**Expone la importancia** del respeto a la vida humana en todas sus etapas, tomando en cuenta los derechos humanos, valores éticos y religiosos.",
  "**Analiza acciones que** muestran el respeto a la vida en su contexto familiar, escolar y social.",
  "**Propone criterios para** la valoración de la vida humana, tomando en cuenta los derechos humanos y los valores éticos y religiosos.",
  "**Describe valores relacionados** al trabajo en su familia, la escuela y la sociedad.",
  "**Expone la importancia** de la práctica de valores en la realización del trabajo humano.",
  "**Analiza los aportes** del trabajo para el desarrollo de las personas, las familias y las sociedades.",
  "**Describe situaciones, características** y costumbres, que conforman su realidad familiar, cultural y social.",
  "**Argumenta sobre la** importancia de los valores humanos y cristianos en la resolución de los conflictos familiares y sociales.",
  "**Promueve acciones que** favorecen la resolución de conflictos en la familia y la sociedad, a partir de valores humanos y cristianos.",
  "**Argumenta sobre la** misión de Jesús de Nazaret al cumplir la voluntad de Dios y lo reconoce como modelo de vida.",
  "**Describe las manifestaciones** de amor de Jesús de Nazaret hacia las personas y sus actitudes para el fortalecimiento de las relaciones armónicas.",
  "**Expresa el significado** de la pasión, muerte y resurrección de Jesús de Nazaret para las personas e incorpora estas enseñanzas en su vida cotidiana.",
  "**Expone de manera** creativa la importancia que tiene la tecnología en el desarrollo de la sociedad, de las personas y el entorno natural, aplicando criterios éticos.",
  "**Relata situaciones y** hechos de vida que se han solucionado con el uso de la ciencia y la tecnología, tomando como referencia criterios éticos en su aplicación.",
  "**Argumenta sobre los** dilemas éticos relacionados con el uso de la ciencia y la tecnología en la vida de las personas y el desarrollo de la sociedad.",
  "**Se involucra en** proyectos para la resolución de problemas relacionados con el cuidado y sostenimiento del entorno natural en la familia, la escuela y la comunidad.",
  "**Emite juicios críticos** ante situaciones de deterioro al entorno natural, fundamentado en principios éticos.",
  "**Evidencia acciones en** su vida cotidiana que promueven el respeto y la conservación del entorno natural como casa común en su familia, la escuela y la comunidad.",
  "**Explica de manera** creativa las características de los cambios que acontecen en la adolescencia.",
  "**Argumenta sobre la** influencia de los cambios que experimentan los adolescentes en sus decisiones, intereses y comportamientos.",
  "**Propone acciones que** favorecen el desarrollo humano y espiritual durante la etapa de la adolescencia."
];
...
const DRAFT_KEY = "plx:sec_formacion2do_unidad_draft";
...
<p>${result.ampliacion?.descripcion || "Actividad avanzada de investigación o creación autónoma."}</p>`;
  ...
  const handleGenerateRetroalimentacion = async () => {
    ...
    toast.loading("Generando retroalimentación con IA para 2do Grado de Secundaria...", { id: "ai-retro" });
    ...
    try {
        ...
        try {
          ...
          const formacionPlans = plannings
            .filter(p => {
              ...
              const isGrade2 = normPlanGrado.includes("2") || normPlanGrado.includes("segund") || normPlanGrado.includes("2do");
              ...
              return isFormacion && isSecundariaPlan && isGrade2 && !isCurrentPlan;
            })
      ...
      const planContext = {
        ...
        grado: "2do Grado de Secundaria",
        level: "SECUNDARIA",
        titulo: latestPlan?.titulo || `${selectedSequence?.name || 'Unidad'} - ${tituloPlan || 'Valores y Desarrollo Personal'}`,
        intencion_pedagogica: latestPlan?.intencion_pedagogica || intencionPedagogica || "Reflexionar sobre los valores éticos, morales y espirituales de la unidad.",
      };
      ...
      toast.success("¡Retroalimentación generada con éxito para 2do Grado de Secundaria!", { id: "ai-retro" });
    } catch (err) {
      console.error(err);
  ...
  const handleSynthesize = async (selectedPlans: any[]) => {
    ...
    try {
      ...
      const staticUnits = getUnitsBySubjectAndGrade('formacion-humana', '2do Sec');
      const filteredCustom = customUnitsRaw
        .filter(cu => (cu.subject_id === 'formacion-humana' || cu.subject_id === 'formacion-humana-sec') && (cu.grade_id === '2do Sec' || cu.grade_id === 'secundaria-2do'))
        .map(cu => cu.content);
        ...
        >
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Field label="Grado" required>
              <input className={inputCls} value="2do. (Secundaria)" readOnly />
            </Field>
