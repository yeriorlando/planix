...
// Import sequences
import seqConversacion from "./Secuencias/seq-1-la-conversacion.json";
import seqCartaExcusas from "./Secuencias/seq-2-la-carta-de-agradecimiento.json";
import seqAnecdota from "./Secuencias/seq-3-la-anecdota.json";
import seqReceta from "./Secuencias/seq-4-la-receta.json";
import seqArticuloExpositivo from "./Secuencias/seq-5-el-articulo-expositivo.json";
import seqInformeLectura from "./Secuencias/seq-6-el-informe-de-lectura.json";
import seqComentario from "./Secuencias/seq-7-el-comentario.json";
import seqAnuncio from "./Secuencias/seq-8-el-anuncio-radial.json";
import seqCuentos from "./Secuencias/seq-9-el-cuento.json";
import seqCopla from "./Secuencias/seq-10-la-oda.json";
...
const LENGUA_6TO_DESCRIPTIONS = [
  "La conversación: Comprensión y producción oral/escrita de conversaciones sobre temas cotidianos.",
  "La carta de agradecimiento: Comprensión y producción de cartas de agradecimiento.",
  "La anécdota: Comprensión y producción de anécdotas sobre situaciones cotidianas o familiares.",
  "La receta: Comprensión y producción de recetas sobre platos saludables.",
  "El artículo expositivo: Comprensión y producción de artículos expositivos sobre temas científicos o sociales.",
  "El informe de lectura: Comprensión y producción de informes de lectura sobre textos diversos.",
  "El comentario: Comprensión y producción de comentarios sobre temas escolares o comunitarios.",
  "El anuncio radial: Comprensión y producción de anuncios radiales.",
  "El cuento: Comprensión y producción de cuentos con estructura y recursos literarios complejos.",
  "La oda: Comprensión y producción de odas y poemas."
];

const LENGUA_6TO_SEQUENCES = [
  seqConversacion,
  seqCartaExcusas,
  seqAnecdota,
  seqReceta,
  seqArticuloExpositivo,
  seqInformeLectura,
  seqComentario,
  seqAnuncio,
  seqCuentos,
  ...
  const seqId = `seq-${idx+1}-lengua-6to`;
  const activities = (seq.activities || []).map((act: any, aIdx: number) => ({
    ...act,
    id: act.id || `act-${seqId}-${aIdx+1}`,
    title: act.title || act.activityTitle || `Actividad ${aIdx+1}`
  }));
  return {
    ...seq,
    id: seqId,
    title: seq.title || seq.sequenceTitle || `Secuencia ${idx+1}`,
    description: LENGUA_6TO_DESCRIPTIONS[idx],
...
const COMPETENCIAS: { key: CompetenciaKey; label: string; defaultDesc: string }[] = [
  {
    ...
    label: "Comunicativa",
    defaultDesc:
      "Expresa y comprende, de forma oral y escrita en diferentes contextos, textos funcionales y literarios de extensión más amplia y estructuras sintácticas más complejas, utilizando medios y recursos variados, demostrando mayor avance en los procesos de lectura y escritura, con mayor nivel de autonomía.",
  },
  {
    key: "logico",
  ...
  },
  {
    ...
    defaultDesc:
      "Utiliza textos variados para conocer y cuestionar las prácticas sociales de ciudadanía; con la finalidad de promover valores universales y humanísticos, así como la divulgación y promoción de situaciones de salud y medio ambiente, mediante el uso de herramientas tecnológicas, entre otras.",
  },
];
...
const SEQUENCE_COMPETENCIES: Record<string, string[]> = {
  "La conversación": [
    "Comprensión oral: Comprende conversaciones que tienen lugar en el entorno escolar y comunitario, para el desarrollo de las capacidades personales y de interacción social.",
    "Producción oral: Participa en conversaciones que tienen lugar en el entorno escolar para el desarrollo de capacidades personales y de interacción social."
  ],
  "La carta de agradecimiento": [
    "Comprensión oral: Comprende la información de diferentes cartas de agradecimiento que escucha.",
    "Producción oral: Produce oralmente cartas de agradecimiento de acuerdo con situaciones previstas o imprevistas de la cotidianidad.",
    "Comprensión escrita: Comprende la información de cartas de agradecimiento que lee.",
    "Producción escrita: Produce cartas por escrito para agradecer algún acontecimiento concreto o alguna circunstancia en particular."
  ],
  ...
  "La anécdota": [
    "Comprensión oral: Comprende anécdotas que escucha sobre personas y situaciones del país y del mundo para el disfrute y la ejemplificación de un tema.",
    "Producción oral: Produce oralmente, con creatividad y capacidad expresiva, anécdotas sobre personas y situaciones del país y del mundo para la ejemplificación de un tema y el disfrute de los/las interlocutores/as.",
    "Comprensión escrita: Comprende anécdotas que lee sobre situaciones y personas destacadas del país y del mundo para el disfrute y la ejemplificación de un tema.",
    "Producción escrita: Produce por escrito anécdotas sobre hechos significativos ocurridos a personas destacadas del país y del mundo, con creatividad y capacidad expresiva para el disfrute personal y de los/las interlocutores/as."
  ],
  "La receta": [
    "Comprensión oral: Comprende recetas que escucha para saber cómo se preparan platos del recetario mundial.",
    "Producción oral: Produce oralmente recetas para dar a conocer cómo se preparan platos del recetario mundial.",
    "Comprensión escrita: Comprende recetas que lee para saber cómo se preparan platos culinarios del recetario mundial.",
    "Producción escrita: Produce de forma escrita recetas para preparar platos culinarios del recetario mundial."
  ],
  "El artículo expositivo": [
    "Comprensión oral: Comprende artículos expositivos que escucha para conocer y explicar sobre temas de la naturaleza y sucesos históricos.",
    "Producción oral: Produce oralmente artículos expositivos para explicar temas de la naturaleza y sucesos históricos.",
    "Comprensión escrita: Comprende artículos expositivos que lee para conocer y explicar sobre temas de la naturaleza y sucesos históricos.",
    "Producción escrita: Produce por escrito artículos expositivos para explicar temas de la naturaleza y sucesos históricos."
  ],
  "Artículo expositivo": [
    "Comprensión oral: Comprende artículos expositivos que escucha para conocer y explicar sobre temas de la naturaleza y sucesos históricos.",
    "Producción oral: Produce oralmente artículos expositivos para explicar temas de la naturaleza y sucesos históricos.",
  ...
  "El informe de lectura": [
    "Comprensión oral: Comprende el análisis de la descripción del ambiente físico y psicológico de cuentos, fábulas y leyendas en los informes de lectura que escucha.",
    "Producción oral: Produce oralmente informes de lectura para analizar el ambiente físico y psicológico de cuentos, fábulas y leyendas.",
    "Comprensión escrita: Comprende el análisis de la descripción del ambiente físico y psicológico en los informes de lectura que lee sobre cuentos, fábulas y leyendas.",
    "Producción escrita: Produce por escrito informes de lectura para analizar el ambiente físico y psicológico de textos de secuencia narrativa, como cuentos, fábulas, leyendas."
  ],
  "Informe de lectura": [
    "Comprensión oral: Comprende el análisis de la descripción del ambiente físico y psicológico de cuentos, fábulas y leyendas en los informes de lectura que escucha.",
    "Producción oral: Produce oralmente informes de lectura para analizar el ambiente físico y psicológico de cuentos, fábulas y leyendas.",
  ...
  "El comentario": [
    "Comprensión oral: Comprende comentarios que escucha sobre hechos y situaciones de la realidad social.",
    "Producción oral: Produce oralmente comentarios sobre hechos y situaciones de la realidad social.",
    "Comprensión escrita: Comprende comentarios que lee sobre hechos y situaciones de la realidad social.",
    "Producción escrita: Produce de manera escrita comentarios de dos párrafos donde expresa opiniones apoyadas con, por lo menos, dos razones válidas sobre hechos y situaciones de la realidad social para un público general."
  ],
  "El anuncio radial": [
    "Comprensión oral: Comprende anuncios radiales que escucha para comprar un producto, participar en un evento o realizar acciones de interés social.",
    "Producción oral: Produce oralmente anuncios radiales con creatividad para persuadir a otros de comprar un producto, participar en un evento o realizar acciones de interés social.",
    "Comprensión escrita: Comprende los mensajes de texto de anuncios radiales que lee para comprar un producto, participar en un evento o realizar acciones de interés social.",
    "Producción escrita: Produce el mensaje de texto de los anuncios radiales con creatividad para persuadir a otros de comprar un producto, participar en un evento o realizar acciones de interés social."
  ],
  "Anuncio radial": [
    "Comprensión oral: Comprende anuncios radiales que escucha para comprar un producto, participar en un evento o realizar acciones de interés social.",
    "Producción oral: Produce oralmente anuncios radiales con creatividad para persuadir a otros de comprar un producto, participar en un evento o realizar acciones de interés social.",
  ...
  "El cuento": [
    "Comprensión oral: Comprende cuentos que escucha para el disfrute y desarrollo de la imaginación y la creatividad.",
    "Producción oral: Produce oralmente cuentos para entretener a los/as compañeros/as, familiares y personas de la comunidad a través de la imaginación y la creatividad.",
    "Comprensión escrita: Comprende cuentos que lee para el disfrute y el desarrollo de la imaginación y la creatividad.",
    "Producción escrita: Produce cuentos escritos para narrar historias de forma creativa con la intención de entretener a compañeros/as, familiares y personas de la comunidad."
  ],
  "La oda": [
    "Comprensión oral: Comprende odas breves que escucha con el fin de conocer las alabanzas que su autor/a hace de las cualidades de personas u objetos, para el disfrute y desarrollo de la creatividad y sensibilidad.",
    "Producción oral: Recita odas breves que destacan las cualidades que poseen personas u objetos, para el disfrute y desarrollo de la creatividad y sensibilidad.",
    "Comprensión escrita: Comprende odas breves que lee con el fin de conocer las alabanzas que su autor/a hace de las cualidades de personas u objetos, para el disfrute y desarrollo de la creatividad y sensibilidad.",
    "Producción escrita: Escribe odas breves que alaban las cualidades que poseen personas u objetos, para el disfrute y desarrollo de la creatividad y sensibilidad."
  ],
  "Oda": [
    "Comprensión oral: Comprende odas breves que escucha con el fin de conocer las alabanzas que su autor/a hace de las cualidades de personas u objetos, para el disfrute y desarrollo de la creatividad y sensibilidad.",
    "Producción oral: Recita odas breves que destacan las cualidades que poseen personas u objetos, para el disfrute y desarrollo de la creatividad y sensibilidad.",
...
const FALLBACK_INDICATORS = [
  "**Comprende conversaciones, cartas de agradecimiento,** anécdotas, recetas, artículos expositivos, informes de lectura, comentarios, anuncios radiales, cuentos y odas que escucha, identificando su propósito, estructura y elementos característicos.",
  "**Comprende diversos tipos** de textos escritos (cartas de agradecimiento, anécdotas, recetas, artículos expositivos, informes de lectura, comentarios, anuncios radiales, cuentos y odas), identificando su estructura, propósito y recursos lingüísticos.",
  "**Participa en conversaciones** y exposiciones orales respetando los turnos de palabra, utilizando un tono de voz adecuado y mostrando interés a través de su expresión gestual y corporal.",
  "**Produce oralmente anécdotas,** recetas, artículos expositivos, informes de lectura, comentarios, cuentos y odas, organizando la información de manera coherente y adecuando el vocabulario al propósito comunicativo.",
  "**Redacta cartas de** agradecimiento, anécdotas, recetas, artículos expositivos, informes de lectura, comentarios, cuentos y odas, respetando la estructura propia de cada género textual.",
  "**Aplica el proceso** de escritura (planificación, textualización, revisión y edición) en la producción de sus textos, realizando los borradores necesarios para mejorar la calidad del mensaje.",
  "**Utiliza recursos lingüísticos** adecuados a cada tipo de texto: verbos en pasado y presente, adjetivos calificativos, conectores de orden, causa y consecuencia, y expresiones de comparación.",
  "**Respeta las convenciones** de la lengua escrita: uso de mayúsculas, signos de puntuación (punto, coma, dos puntos, raya de diálogo), concordancia entre sujeto y predicado, y ortografía de palabras de uso frecuente.",
  "**Identifica y diferencia** hechos de opiniones en textos argumentativos (comentarios), reconociendo el carácter polémico de la argumentación y respetando las opiniones ajenas.",
  "**Valora la función** social de los diferentes tipos de textos en su vida cotidiana: agradecer apoyos, relatar anécdotas, compartir recetas familiares, aprender sobre la naturaleza, disfrutar de la literatura y expresar sus opiniones.",
  "**Demuestra creatividad e** imaginación en la producción de cuentos, odas y anuncios radiales, utilizando recursos como diálogos, descripciones, y recursos estilísticos propios de cada género.",
  "**Evalúa su propio** desempeño y el de sus compañeros mediante la autoevaluación y coevaluación, utilizando listas de cotejo y rúbricas con criterios previamente establecidos.",
  "**Investiga en diferentes** fuentes bibliográficas (libros, internet, revistas) para recopilar información sobre temas de estudio, seleccionando datos relevantes y expresándolos con sus propias palabras.",
  "**Participa en proyectos** colaborativos (recitales, debates, publicaciones colectivas) compartiendo sus producciones orales y escritas con la comunidad educativa.",
  "**Reflexiona sobre los** valores y mensajes presentes en los textos leídos (solidaridad, gratitud, perseverancia, respeto, amistad), relacionándolos con su propia vida y su entorno familiar y escolar."
];

export interface LenguaEspañola6toProps {
  user: any;
...
const DRAFT_KEY = "plx:lengua6to_draft";
...
export default function LenguaEspañola6to({
  user,
  selectedSequence,
  ...
  const getSequenceData = (idx: number) => {
    const original = LENGUA_6TO_SEQUENCES[idx] || LENGUA_6TO_SEQUENCES[0];
    ...
    try {
      ...
      const languagePlans = plannings
        .filter(p => {
          ...
          const isLanguage = normAsig.includes("lengua") || normAsig.includes("espanol") || normTit.includes("lengua") || normTit.includes("espanol");
          ...
          const isSameGrade = normPlanGrado.includes("6") || normPlanGrado.includes("sext");
      ...
      if (!latestPlan) {
        latestPlan = {
          id: "temp-plan-id",
          docente_id: user.id,
          titulo: (activeActivityData as any)?.title || (activeActivityData as any)?.activityTitle || activeSequenceData?.title || "Lengua Española 6to Grado",
          tipo: selectedSequenceType,
          nivel: "primaria",
          grado: selectedGrade || "6to. (Primaria)",
          asignatura: "Lengua Española",
          secuencia_id: selectedSequence?.id || "",
          bloque_id: "",
          actividad_id: (activeActivityData as any)?.id || "",
          intencion_pedagogica: intencionPedagogica || "Desarrollar competencias comunicativas en Lengua Española",
          recursos: [],
          momentos: { 
        ...
        <div className="mb-8 relative border-b border-slate-100 dark:border-zinc-800 pb-5 text-center">
          <div className="animate-in fade-in slide-in-from-top-4 duration-500">
            ...
            <p className="mt-2 text-sm font-black text-slate-500 dark:text-zinc-400 uppercase tracking-widest">
              Planificación diaria (6to Grado)
            </p>
          </div>
          <button
            type="button"
            ...
            <div className="space-y-2 text-left">
              {(() => {
                const compIcons: Record<CompetenciaKey, React.ReactNode> = {
                  ...
                  logico: <Brain className="h-4.5 w-4.5" />,
