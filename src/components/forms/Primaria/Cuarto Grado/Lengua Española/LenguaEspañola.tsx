...
import seqCartaSolicitud from "./Secuencias/seq-2-la-carta-de-solicitud-de-permiso.json";
import seqBiografia from "./Secuencias/seq-3-la-biografia.json";
...
import seqCuentos from "./Secuencias/seq-8-el-cuento.json";
import seqHistorieta from "./Secuencias/seq-9-la-historieta.json";
import seqAcrostico from "./Secuencias/seq-10-el-acrostico.json";
...
const LENGUA_4TO_DESCRIPTIONS = [
  "La conversación: Comprensión y producción oral/escrita de conversaciones sobre temas cotidianos.",
  "La carta de solicitud de permiso: Comprensión y producción de cartas de solicitud de permiso.",
  "La biografía: Comprensión y producción de biografías de personas destacadas a nivel mundial.",
  "La receta: Comprensión y producción de recetas para platos sencillos de la comunidad.",
  "El artículo expositivo: Comprensión y producción de artículos expositivos sobre la naturaleza y sucesos.",
  "El informe de lectura: Comprensión y producción de informes de lectura sobre cuentos, fábulas y leyendas.",
  "El comentario: Comprensión y producción de comentarios sobre la realidad personal y familiar.",
  "El cuento: Comprensión y producción de cuentos infantiles para el disfrute y creatividad.",
  "La historieta: Comprensión y producción de historietas para la recreación y creatividad.",
  "El acróstico: Comprensión y producción de acrósticos para el disfrute y desarrollo de la sensibilidad."
];

const LENGUA_4TO_SEQUENCES = [
  seqConversacion,
  seqCartaSolicitud,
  seqBiografia,
  seqReceta,
  ...
  const seqId = `seq-${idx+1}-lengua-4to`;
  ...
  return {
    ...
    description: LENGUA_4TO_DESCRIPTIONS[idx],
...
const SEQUENCE_COMPETENCIES: Record<string, string[]> = {
  "La conversación": [
    "Comprensión oral: Comprende conversaciones sencillas sobre temas cotidianos y de su interés para el desarrollo de la capacidad de interacción social.",
    "Producción oral: Participa en conversaciones sencillas sobre temas cotidianos y de su interés para el desarrollo de la capacidad de interacción social."
  ],
  "La carta de solicitud de permiso": [
    "Comprensión oral: Comprende la información de diferentes cartas de solicitud de permiso que escucha.",
    "Producción oral: Produce oralmente el asunto que motiva la carta de solicitud de permiso.",
    "Comprensión escrita: Comprende la información de cartas de solicitud de permiso que lee.",
    "Producción escrita: Redacta cartas para solicitar permisos diversos a familiares y personas de la comunidad según las necesidades personales y las del entorno cercano."
  ],
  "La biografía": [
    "Comprensión oral: Comprende biografías que escucha sobre personas destacadas a nivel mundial.",
    "Producción oral: Produce oralmente biografías sobre personas destacadas a nivel mundial.",
    "Comprensión escrita: Comprende biografías que lee para conocer personas destacadas a nivel mundial.",
    "Producción escrita: Produce biografías escritas sobre la vida y obra de personas destacadas a nivel mundial."
  ],
  "La receta": [
    "Comprensión oral: Comprende recetas que escucha para saber cómo se preparan platos sencillos de la comunidad que no impliquen cocción.",
    "Producción oral: Produce recetas de forma oral para preparar platos sencillos de la comunidad que no impliquen cocción.",
    "Comprensión escrita: Comprende recetas que lee para saber cómo se preparan platos sencillos de la comunidad que no impliquen cocción.",
    "Producción escrita: Produce recetas diversas para preparar platos sencillos de la comunidad que no impliquen cocción."
  ],
  "El artículo expositivo": [
    "Comprensión oral: Comprende artículos expositivos que escucha para aprender sobre temas de la naturaleza y sucesos históricos.",
    "Producción oral: Produce oralmente artículos expositivos para explicar temas de la naturaleza y sucesos históricos.",
    "Comprensión escrita: Comprende artículos expositivos que lee para encontrar explicaciones sobre temas de la naturaleza y sucesos históricos.",
    "Producción escrita: Produce artículos expositivos escritos para explicar temas de la naturaleza y sucesos históricos."
  ],
  "El informe de lectura": [
    "Comprensión oral: Comprende la caracterización de los sucesos y los personajes en informes de lectura que escucha sobre cuentos, fábulas y leyendas.",
    "Producción oral: Produce oralmente informes de lectura para caracterizar los sucesos y los personajes de cuentos, fábulas y leyendas.",
    "Comprensión escrita: Comprende la caracterización de los sucesos y los personajes en los informes de lectura que lee de cuentos, fábulas y leyendas.",
    "Producción escrita: Produce por escrito informes de lectura para caracterizar los sucesos y los personajes de cuentos, fábulas y leyendas."
  ],
  "El comentario": [
    "Comprensión oral: Comprende comentarios breves que escucha sobre comportamientos, valores y actitudes propias de la realidad personal y familiar.",
    "Producción oral: Produce oralmente comentarios breves sobre comportamientos, valores y actitudes propias de la reality personal y familiar.",
    "Comprensión escrita: Comprende comentarios breves que lee sobre comportamientos, valores y actitudes propias de la reality personal y familiar.",
    "Producción escrita: Produce de manera escrita comentarios de un párrafo donde exprese la opinión personal apoyada con, por lo menos, dos razones válidas sobre comportamientos, valores y actitudes propias de la reality personal y familiar; para ser publicadas en el mural de la escuela."
  ],
  "El cuento": [
    "Comprensión oral: Comprende cuentos que escucha para el disfrute y el desarrollo de la imaginación y la creatividad.",
    "Producción oral: Produce oralmente cuentos para entretener a sus compañeros y compañeras a través de historias que fomentan la imaginación y la creatividad.",
    "Comprensión escrita: Comprende cuentos que lee para el disfrute y desarrollo de la imaginación y la creatividad.",
    "Producción escrita: Produce cuentos escritos para narrar historias de forma creativa con la intención de entretener a sus compañeros y compañeras."
  ],
  "La historieta": [
    "Comprensión escrita: Comprende historietas que lee para su recreación y desarrollo de la imaginación y la creatividad.",
    "Producción escrita: Produce historietas con creatividad para entretener a sus compañeros y compañeras."
  ],
  "El acróstico": [
    "Comprensión oral: Comprende acrósticos que escucha para el disfrute y desarrollo de la sensibilidad y la creatividad.",
    "Producción oral: Recita acrósticos de su autoría y de autores españoles, latinoamericanos, caribeños y dominicanos para el disfrute de la sensibilidad y la creatividad.",
    "Comprensión escrita: Comprende acrósticos que lee para el disfrute y desarrollo de la sensibilidad y la creatividad.",
    "Producción escrita: Escribe acrósticos para el disfrute de la sensibilidad y la creatividad."
  ]
};

const FALLBACK_INDICATORS = [
  "**Comprende conversaciones, cartas,** biografías, recetas, artículos expositivos, informes de lectura, comentarios, cuentos, historietas y acrósticos que escucha, identificando su propósito, estructura y elementos característicos.",
  "**Comprende diversos tipos** de textos escritos (cartas, biografías, recetas, artículos expositivos, informes de lectura, comentarios, cuentos, historietas y acrósticos), identificando su estructura, propósito y recursos lingüísticos.",
  ...
  "**Produce oralmente biografías,** recetas, artículos expositivos, informes de lectura, comentarios, cuentos y acrósticos, organizando la información de manera coherente y adecuando el vocabulario al propósito comunicativo.",
  "**Redacta cartas de** solicitud de permiso, biografías, recetas, artículos expositivos, informes de lectura, comentarios, cuentos, historietas y acrósticos, respetando la estructura propia de cada género textual.",
  ...
  "**Valora la función** social de los diferentes tipos de textos en su vida cotidiana: pedir permiso, compartir recetas familiares, conocer la vida de personas destacadas, disfrutar de la literatura y expresar sus opiniones.",
  "**Demuestra creatividad e** imaginación en la producción de cuentos, historietas y acrósticos, utilizando recursos como diálogos, descripciones, onomatopeyas y la estructura de inicio, nudo y desenlace.",
  ...
  "**Investiga en diferentes** fuentes bibliográficas (libros, internet, revistas) para recopilar información sobre personajes destacados o temas de estudio, seleccionando datos relevantes y expresándolos con sus propias palabras.",
  "**Participa en proyectos** colaborativos (tertulias literarias, congresos, publicaciones colectivas) compartiendo sus producciones orales y escritas con la comunidad educativa.",
  "**Reflexiona sobre los** valores y mensajes presentes en los textos leídos (solidaridad, perseverancia, respeto, amistad), relacionándolos con su propia vida y su entorno familiar y escolar."
];
...
const DRAFT_KEY = "plx:lengua4to_draft";
...
export default function LenguaEspañola({
  ...
  const getSequenceData = (idx: number) => {
    const original = LENGUA_4TO_SEQUENCES[idx] || LENGUA_4TO_SEQUENCES[0];
    ...
    try {
      ...
      const languagePlans = plannings
        .filter(p => {
          ...
          const isSameGrade = normPlanGrado.includes("4") || normPlanGrado.includes("cuart");
      ...
      if (!latestPlan) {
        latestPlan = {
          id: "temp-plan-id",
          docente_id: user.id,
          titulo: (activeActivityData as any)?.title || (activeActivityData as any)?.activityTitle || activeSequenceData?.title || "Lengua Española 4to Grado",
          tipo: selectedSequenceType,
          nivel: "primaria",
          grado: selectedGrade || "4to. (Primaria)",
          asignatura: "Lengua Española",
        ...
        <div className="mb-8 relative border-b border-slate-100 dark:border-zinc-800 pb-5 text-center">
          <div className="animate-in fade-in slide-in-from-top-4 duration-500">
            ...
            <p className="mt-2 text-sm font-black text-slate-500 dark:text-zinc-400 uppercase tracking-widest">
              Planificación diaria (4to Grado)
            </p>
          </div>
          <button
            type="button"
        ...
        >
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Field label="Grado" required>
              <input className={inputCls} value="4to. (Primaria)" readOnly />
            </Field>
