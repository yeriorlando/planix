...
const COMPETENCIAS: { key: CompetenciaKey; label: string; defaultDesc: string }[] = [
  {
    ...
    label: "Comunicativa",
    defaultDesc:
      "Evalúa distintas fuentes geográficas e históricas, en el análisis de acontecimientos; con la finalidad de comprender el pasado y reconocer el espacio geográfico que ocupa su municipio, provincia, región y país.",
  },
  {
    key: "logico",
    label: "Pensamiento Lógico, Creativo y Crítico; Resolución de Problemas; Tecnológica y Científica",
    defaultDesc:
      "Utiliza procedimientos científicos y tecnológicos en el análisis crítico de fenómenos geográficos, hechos históricos y culturales de la provincia, región y país; con la finalidad de realizar propuestas lógicas y creativas.",
  },
  {
    key: "etica",
    label: "Ética y Ciudadana; Desarrollo Personal y Espiritual; Ambiental y de la Salud",
    defaultDesc:
      "Ejemplifica en sus actuaciones el respeto a sí mismo y a las demás personas; con la finalidad de promover relaciones democráticas y armoniosas, el cuidado a su entorno natural y la construcción de una cultura de paz en el municipio y región donde vive.",
  },
];
...
const FALLBACK_INDICATORS = [
  ...
  "**Distingue de manera lógica** en mapas y otras fuentes, informaciones sobre el espacio geográfico y acontecimientos históricos que caracterizan su municipio, provincia, región y país",
  ...
  "**Utiliza procedimientos científicos y tecnológicos** en el análisis crítico de los componentes de la tierra fenómenos y aspectos históricos de las Antillas mayores y menores.",
  ...
  "**Defiende y promueve** planteamientos sobre una ciudadanía basada en la participación democrática y promotora de la cultura de paz en su entorno."
];
...
const DRAFT_KEY = "plx:sociales3ro_unidad_draft";
  ...
  const handleGenerateRetroalimentacion = async () => {
    ...
    try {
      ...
      if (socPlans.length === 0) {
        toast.error("No se encontró ninguna planificación anterior de Ciencias Sociales de 3ro. (Primaria) para esta cuenta.", { id: "ai-retro" });
        return;
      }
