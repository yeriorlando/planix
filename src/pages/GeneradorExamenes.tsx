...
import { 
    ...
    BookText, Ruler, Globe, Leaf, Palette, Dumbbell, Heart, Languages, ChevronDown, Check, X
} from 'lucide-react';
        ...
        <div className="min-h-screen pb-24 print:bg-white print:p-0 w-full flex-1">
            ...
            <header className="print:hidden flex items-center justify-between px-6 py-4 max-w-4xl mx-auto bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md rounded-2xl border border-slate-100 dark:border-zinc-800 shadow-2xs mb-6 mt-4">
                ...
                <div className="flex items-center gap-3">
                    {isPremium ? (
                        <span className="text-[10px] font-black text-amber-700 bg-amber-100 dark:bg-amber-950/40 dark:text-amber-400 px-3 py-1.5 rounded-full border border-amber-200 dark:border-amber-900/50 uppercase tracking-wider flex items-center gap-1.5">
                            👑 Premium Ilimitado
                        </span>
                    ) : (
                        <span className="text-[10px] font-black text-indigo-700 bg-indigo-50 dark:bg-indigo-950/40 dark:text-indigo-400 px-3 py-1.5 rounded-full border border-indigo-150/40 dark:border-indigo-900/50 uppercase tracking-wider">
                            🪙 {getUserCredits(user)} Coins
                        </span>
                    )}
                </div>
            </header>
            ...
            <main className="max-w-4xl mx-auto px-4 print:max-w-none print:px-0">
                ...
                {/* Título Principal */}
                <div className="print:hidden mb-8 space-y-2 text-center md:text-left">
                    <h1 className="text-3xl md:text-4.5xl font-black tracking-tight text-slate-900 dark:text-white leading-tight">
                        Generador de Exámenes <span className="text-brand-primary">IA</span>
                    </h1>
                    <p className="text-slate-500 dark:text-zinc-400 font-medium text-sm md:text-base">
                        Crea evaluaciones estructuradas y claves de respuesta docente personalizadas al instante.
                    </p>
                </div>
                ...
                <div className="print:hidden space-y-6 mb-12">
                    ...
                    <section className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-3xl p-6 shadow-2xs focus-within:shadow-xs transition-shadow">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="w-8 h-8 rounded-full bg-brand-primary/10 text-brand-primary flex items-center justify-center font-black text-sm dark:bg-brand-primary/20 dark:text-blue-400">1</span>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative select-none">
                                    <button 
                                        ...
                                        className="w-full h-10 px-3.5 bg-white dark:bg-zinc-900 border border-neutral-200 dark:border-zinc-800 rounded-lg text-sm text-[#1B1B1B] dark:text-neutral-100 flex items-center justify-between cursor-pointer hover:bg-slate-50 dark:hover:bg-zinc-800 focus:border-brand-primary outline-none transition-all shadow-xs"
                                    >
                    ...
                    <section className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-3xl p-6 shadow-2xs focus-within:shadow-xs transition-shadow">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="w-8 h-8 rounded-full bg-brand-primary/10 text-brand-primary flex items-center justify-center font-black text-sm dark:bg-brand-primary/20 dark:text-blue-400">2</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input type="number" readOnly value={numQuestions} className="w-full bg-slate-100 dark:bg-zinc-950/60 border border-slate-200 dark:border-zinc-800/80 rounded-xl px-4 py-3 text-slate-800 dark:text-zinc-200 font-black text-sm outline-none cursor-default pr-16" />
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input type="text" value={topic} onChange={e => setTopic(e.target.value)} placeholder="Ej: La Célula, Las Fracciones, La Noticia..." className="w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 dark:focus:border-zinc-700 dark:focus:ring-white/5 rounded-xl px-4 py-3 text-slate-800 dark:text-zinc-150 font-bold text-sm outline-none transition-all" />
                            </div>
                            <div className="space-y-2">
                                ...
                                <textarea value={indicators} onChange={e => setIndicators(e.target.value)} placeholder="Pega aquí los indicadores oficiales del currículo..." className="w-full h-24 bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 dark:focus:border-zinc-700 dark:focus:ring-white/5 rounded-xl px-4 py-3 text-slate-800 dark:text-zinc-150 font-medium text-sm outline-none transition-all resize-none" />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-3xl p-6 shadow-2xs focus-within:shadow-xs transition-shadow">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="w-8 h-8 rounded-full bg-brand-primary/10 text-brand-primary flex items-center justify-center font-black text-sm dark:bg-brand-primary/20 dark:text-blue-400">3</span>
                        ...
                        <div className="print:hidden flex flex-col md:flex-row justify-between items-center gap-4 mb-10 pb-6 border-b border-slate-100 dark:border-zinc-800">
                            ...
                            <div className="flex items-center bg-slate-100 dark:bg-zinc-950 p-1.5 rounded-xl border border-slate-200/50 dark:border-zinc-800">
                                ...
                                <button 
                                    ...
                                    className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-xs font-black transition-all cursor-pointer ${
                                        viewMode === 'teacher' 
                                            ? 'bg-white dark:bg-zinc-800 text-rose-600 dark:text-rose-450 shadow-xs' 
                                            : 'text-slate-500 hover:text-slate-800 dark:text-zinc-400 dark:hover:text-zinc-200'
                                    }`}
                                >
